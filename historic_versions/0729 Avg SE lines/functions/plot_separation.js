...
*/
 ...
 avg_sum = 0;  //sum of all neutron/proton of different EDFs, for later average purpose
 avg_weight = 0;
 avg_SE = 0;
 i = 0;
...
//neutron S.E. average
 for (bz = 2; bz < 121; bz += 2 ){
     ...
     N_SE_avg[N_SE_avg.length] = [avg_SE, bz];
...
//proton S.E. average
 for (bn = 2; bn < 301; bn += 2 ){
     ...
     try {
     avg_sum += Number(M1||M7)*(dataS1_2P[i][1]);
     avg_weight += Number(M1||M7)*(dataS1_2P[i][1] != 0 );
     }
     catch(err){}
     
     try {
     avg_sum += Number(M2||M7)*(dataS2_2P[i][1]);
     avg_weight += Number(M2||M7)*(dataS2_2P[i][1] != 0 );
     }
     catch(err){}
     
     try {
     avg_sum += Number(M3||M7)*(dataS3_2P[i][1]);
     avg_weight += Number(M3||M7)*(dataS3_2P[i][1] != 0 );
     }
     catch(err){}
     
     try {
     avg_sum += Number(M4||M7)*(dataS4_2P[i][1]);
     avg_weight += Number(M4||M7)*(dataS4_2P[i][1] != 0 );
     }
     catch(err){}
     
     try {
     avg_sum += Number(M5||M7)*(dataS5_2P[i][1]);
     avg_weight += Number(M5||M7)*(dataS5_2P[i][1] != 0 );
     }
     catch(err){}
     
     try {
     avg_sum += Number(M6||M7)*(dataS6_2P[i][1]);
     avg_weight += Number(M6||M7)*(dataS6_2P[i][1] != 0 );
     }
     catch(err){}
...
//Replicated data arrays (so that when chosen 'only plot avg S.E. option these data will not be plotted')
 ...
 if (M10) {
     ...
     label1 = '', label2 = '', label3 = '', label4 = '', label5 = '', label6 = '', label9 = 'Avg Separation Energy';
    ...
    //plot dataset
    var dataset = [
                   {data: dataS1R, label: label1, lines:{show:((M1||M7)&&(!M10))}, points:{show:((M1||M7)&&(!M10))}, color: '#3D7A99'},
                   {data: dataS2R, label: label2, lines:{show:((M2||M7)&&(!M10))}, points:{show:((M2||M7)&&(!M10))}, color: '#AA4643'},
                   {data: dataS3R, label: label3, lines:{show:((M3||M7)&&(!M10))}, points:{show:((M3||M7)&&(!M10))}, color: '#FF3399'},
                   {data: dataS4R, label: label4, lines:{show:((M4||M7)&&(!M10))}, points:{show:((M4||M7)&&(!M10))}, color: '#339966'},
                   {data: dataS5R, label: label5, lines:{show:((M5||M7)&&(!M10))}, points:{show:((M5||M7)&&(!M10))}, color:'#3333FF'}
                   ,
                   {data: dataS6R, label: label6, lines:{show:((M6||M7)&&(!M10))}, points:{show:((M6||M7)&&(!M10))}, color:'#FF9900'}
                   ,
