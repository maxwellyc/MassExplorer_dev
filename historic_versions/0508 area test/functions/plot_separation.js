...
function SeparE(V_s2p0, V_s2n0, UNEDF0on2, UNEDF1on2, SKMSon2, SKPon2, SLY4on2, SV_MINon2, ALLon2){
    ...
    //plot dataset
    var dataset = [
                   {data: dataS1, label: label1, lines:{show:(M1||M7)}, points:{show:false}, color: '#ffffff',id:"0"},//3D7A99
                   {data: dataS2, label: label2, lines:{show:(M2||M7)}, points:{show:false}, color: '#AA4643',id:"1",fillBetween:"0"},
                   {data: dataS3, label: label3, lines:{show:(M3||M7)}, points:{show:false}, color: '#FF3399',id:"2",fillBetween:"1"},
                   {data: dataS4, label: label4, lines:{show:false}, points:{show:false}, color: '#339966',id:"3",fillBetween:"2"},
                   {data: dataS5, label: label5, lines:{show:false}, points:{show:false}, color:'#3333FF',id:"4",fillBetween:"3"},
                   {data: dataS6, label: label6, lines:{show:false}, points:{show:false}, color:'#FF9900',id:"5",fillBetween:"4"}//(M6||M7)
                   ];
