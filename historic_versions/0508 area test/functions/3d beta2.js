  ...
  */
         ...
         /*               if(Nnext == N1 || isNaN(Nnext)){
           ...
           */
                ...
                var options = {xPos: 75, yPos: -303 , width: 1000, height: 1000, colourGradient: colours,
                    fillPolygons: true,
                ...
                var legendWidth = 40
                ctx.clearRect(0,0,legendWidth+40,c.height);
                ...
                for (var i = 0; i < numLabels; i++) {
                    ...
                    ctx.fillText((colorLb[i]).toFixed(2), legendWidth+5, i*0.865*interval/dif+parseFloat(zeroLabel[edfTag]));//parseFloat(zeroLabel[edfTag])
                }
